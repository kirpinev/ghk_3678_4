...
export const enum LSKeys {
  CREDITS_GAME_LANDING_CLICK = "credits_game_landing_click_3678_4",
  CREDITS_GAME_BONUS_CLICK = "credits_game_bonus_click_3678_4",
  CREDITS_GAME_BONUS_VARIANT = "credits_game_bonus_variant_3678_4",
  CREDITS_GAME_FINAL_CLICK = "credits_game_final_click_3678_4",
  CREDITS_GAME_LAST_ATTEMPT = "credits_game_last_attempt_3678_4",
  NO_OPTIONS = "noOptions",
  REDUCED_RATE = "reducedRate",
  PAYMENT_DATE = "paymentDate",
  PROTECTION = "protection",
  PAYMENT_SCHEDULE = "paymentSchedule",
  MAX_ATTEMPTS = "maxAttempts_3678_4",
  TOTAL_WIN = "total_win_3678_4",
  USER_UUID = "userUUID_3678_4",
}
